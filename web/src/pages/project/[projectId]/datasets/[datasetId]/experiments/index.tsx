...
export default function Dataset() {
  ...
  const handleExperimentSuccess = async (data?: {
    ...
    showSuccessToast({
      title: t(
        "datasets.experiments.triggered-title",
        "Experiment triggered successfully",
      ),
      description: t(
        "datasets.experiments.triggered-desc",
        "Waiting for experiment to complete...",
      ),
      link: {
        text: t(
          "datasets.experiments.view-experiment",
          "View experiment",
        ),
              ...
              >
                <DialogTrigger asChild disabled={!hasExperimentWriteAccess}>
                  ...
                  >
                    ...
                    {t("datasets.experiments.run-experiment", "Run experiment")}
                  </span>
                  </Button>
                </DialogTrigger>
                ...
                {hasReadAccess && (
                  <DropdownMenuItem asChild>
                    <Link href={`/project/${projectId}/evals?target=dataset`}>
                      ...
                      {t(
                        "datasets.experiments.manage-evaluators",
                        "Manage Evaluators",
                      )}
                    </Link>
                  </DropdownMenuItem>
            ...
            <DialogHeader>
              <DialogTitle>
                {selectedEvaluatorData.evaluator.id
                  ? t("datasets.experiments.edit-evaluator", "Edit Evaluator")
                  : t(
                      "datasets.experiments.configure-evaluator",
                      "Configure Evaluator",
                    )}
              </DialogTitle>
            </DialogHeader>
