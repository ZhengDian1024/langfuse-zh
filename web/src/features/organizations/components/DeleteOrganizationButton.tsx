...
export function DeleteOrganizationButton() {
  ...
  const formSchema = z.object({
    name: z.string().includes(confirmMessage, {
      message: t("organization.delete.confirm-validation", { confirmMessage }),
    }),
  });
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      showSuccessToast({
        title: t("organization.delete.toast.title"),
        description: t("organization.delete.toast.description"),
      });
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {hasProjects
              ? t("organization.delete.has-projects")
              : t("organization.delete.confirm-input", { confirmMessage })}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
