          ...
          <>
              ...
              actionButtons={
                <Button
                  ...
                  onClick={() => {
                    if (hasCommentDraft)
                      toast.error(
                        t("datasets.annotation.save-comment-first", "Please save or discard your comment before proceeding"),
                      );
            ...
            {hasNonAnnotationScores && (
              <div className="text-muted-foreground mt-4 text-xs">
                {t("datasets.annotation.api-scores-hint", "API and eval scores visible on left. Add manual annotations above.")}
              </div>
            )}
          </>
        ) : (
