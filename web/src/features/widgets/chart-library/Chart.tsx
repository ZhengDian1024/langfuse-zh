...
export const Chart = ({
  ...
  const renderWarning = () => (
    <div className="flex flex-col items-center justify-center p-6 text-center">
      ...
      <h3 className="mb-2 text-lg font-semibold">{t("widgets.chart.large-dataset-title", "Large Dataset Warning")}</h3>
      <p className="text-muted-foreground mb-6 text-sm">
        {t("widgets.chart.large-dataset-description", "This chart has more than 2,000 unique data points. Rendering it may be slow or may crash your browser. Try to reduce the number of dimensions by adding more selective filters or choosing a coarser breakdown dimension.")}
      </p>
      <Button
        variant="outline"
      ...
      >
        {t("widgets.chart.large-dataset-confirm", "I understand, proceed to render the chart")}
      </Button>
    </div>
  );
