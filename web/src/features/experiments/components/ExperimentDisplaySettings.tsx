    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline">
          ...
          <span className="ml-2 hidden md:inline">{t("experiments.display.button", "Display")}</span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-56">
        <DropdownMenuLabel>{t("experiments.display.layout", "Layout")}</DropdownMenuLabel>
        <DropdownMenuItem onClick={() => onLayoutChange("grid")}>
          ...
          {t("experiments.display.grid", "Grid")}
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => onLayoutChange("list")}>
          ...
          {t("experiments.display.list", "List")}
        </DropdownMenuItem>

        <DropdownMenuSeparator />

        <DropdownMenuLabel>{t("experiments.display.item-visibility", "Item Visibility")}</DropdownMenuLabel>
        <DropdownMenuItem
        ...
        >
          ...
          {t("experiments.display.show-baseline-only", "Show only items in baseline")}
        </DropdownMenuItem>
        <DropdownMenuItem
        ...
        >
          ...
          {t("experiments.display.show-all", "Show all items")}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
