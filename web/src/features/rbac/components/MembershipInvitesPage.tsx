...
export function MembershipInvitesPage({
  ...
  const columns: LangfuseColumnDef<InvitesTableRow>[] = [
    ...
    },
    {
      ...
      id: "createdAt",
      header: t("rbac.col-invited-on", "Invited On"),
      cell: ({ row }) => {
      ...
      : []),
    {
      ...
      id: "invitedByUser",
      header: t("rbac.col-invited-by", "Invited By"),
      cell: ({ row }) => {
  ...
  return (
    <>
      ...
      <Header title={t("rbac.invites.title", "Membership Invites")} />
